...
class TransformationModelA:
    ...
    based on product technology assumption is created. In the 'Eurostat Manual
    of Supply, Use and Input-Output Tables' this transformation model is called
    model A. The resulting input-output table may contain negative values. Only
